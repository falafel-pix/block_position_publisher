...
class NewController(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('kp_psi', 4.0)
        self.declare_parameter('kd_psi',4.0)
        self.declare_parameter('kp_theta',5.0)
        self.declare_parameter('kd_theta',4.0)
        ...
        self.kdtheta = self.get_parameter('kd_theta').value
...
tau_psi,
    ...
    def x_control(self,f_z, t):
        # safety if force applied continuously for 3 sec, stop applying force for next 5 sec      
